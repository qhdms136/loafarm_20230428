...
public class PermissionInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userId == null && (uri.startsWith("/free/free_create_view") || uri.startsWith("/free/free_detail_view") || uri.startsWith("/free/free_update_view") || uri.startsWith("/free/myfree_view"))) {
		...
		// 비로그인 && notice
		if(userId == null && (uri.startsWith("/notice/notice_detail_view"))){
			response.sendRedirect("/user/sign_in_view");
			return false;
		}
